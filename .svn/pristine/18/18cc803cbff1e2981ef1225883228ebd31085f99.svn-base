"""Module to generate historical Risk Model QA values"""
...
class RMQA:
    ...
    def generateUniCorrReport(self, date, UniType):
        ...
        #Just to insert values for new models
        return 0
    ...
    def generateLeaverReport(self, date, UniType):
        ...
        #Just insert values for new models
        return 0
    ...
    def generateFactorVolTestReport(self, date):
        ...
        #Just to insert value for new models
        return 0
